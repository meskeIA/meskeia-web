...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Calculadora de almíbar', description: 'Azúcar y agua para tu almíbar según el uso.', images: ['https://meskeia.com/coquinum/og-image.png'] },
