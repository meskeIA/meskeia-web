...
export const metadata: Metadata = {
  ...
  description:
    'Calcula el azúcar para tu merengue según el número de claras y el tipo: francés, suizo o italiano. Ideal para cubrir o decorar una tarta (torta o pastel). Para el italiano, también el agua del almíbar. Proporción 1:2 profesional. Gratis y en español.',
  keywords:
    'calculadora merengue, cuanto azucar merengue, merengue frances italiano suizo, proporcion claras azucar merengue, merengue 2 claras, ratio merengue, merengue italiano almibar, merengue para torta, merengue para pastel',
...
export const faqJsonLd = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: '¿Cuántas claras necesito para una tarta (torta o pastel)?', acceptedAnswer: { '@type': 'Answer', text: 'Depende del tamaño, pero para cubrir una tarta mediana (torta o pastel) suelen bastar 3 o 4 claras con su azúcar correspondiente. La herramienta te da el azúcar exacto para el número de claras que pongas, así puedes escalarlo a lo que necesites.' } },
