    ...
    <div className={styles.container}>
      ...
      <div className={styles.chapterContainer}>
        ...
        <nav className={styles.navigation}>
          {prevChapter ? (
            <Link
              href={`/curso-estrategia-empresarial/${prevChapter.module.id}/${prevChapter.chapter.id}`}
              className={styles.navButton}
            >
              ← Anterior
            </Link>
          ) : (
            <Link href="/curso-estrategia-empresarial" className={styles.navButton}>
              ← Índice
            </Link>
          )}
          ...
          <div className={styles.navCenter}>
            ...
            {/* Componente Text-to-Speech reutilizable */}
            <TextToSpeech contentRef={contentRef} resetKey={chapterId} />
          </div>

          {nextChapter ? (
            <Link
              href={`/curso-estrategia-empresarial/${nextChapter.module.id}/${nextChapter.chapter.id}`}
              className={styles.navButton}
            >
              Siguiente →
            </Link>
        ...
        <nav className={styles.bottomNavigation}>
          {prevChapter ? (
            ...
            <Link href="/curso-estrategia-empresarial" className={styles.bottomNavLink}>
          ...
          {nextChapter ? (
            ...
            <Link href="/curso-estrategia-empresarial" className={`${styles.bottomNavLink} ${styles.next}`}>
