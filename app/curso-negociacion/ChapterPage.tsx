    ...
    <div className={styles.container}>
      ...
      <div className={styles.chapterContainer}>
        ...
        <nav className={styles.navigation}>
          {prevChapter ? (
            <Link
              href={`/curso-negociacion/${prevChapter.module.id}/${prevChapter.chapter.id}`}
          ...
          {nextChapter ? (
            <Link
              href={`/curso-negociacion/${nextChapter.module.id}/${nextChapter.chapter.id}`}
              className={styles.navButton}
            >
              Siguiente →
            </Link>
        ...
        <div className={styles.bottomNavigation}>
          {prevChapter ? (
            ...
            <Link href="/curso-negociacion" className={styles.bottomNavLink}>
