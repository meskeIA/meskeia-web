    ...
    <div className={styles.container}>
      ...
      <div className={styles.chapterContainer}>
        ...
        <nav className={styles.navigation}>
          {prevChapter ? (
            <Link
              href={`/curso-pensamiento-cientifico/${prevChapter.module.id}/${prevChapter.chapter.id}`}
              className={styles.navButton}
            >
              ← Anterior
            </Link>
          ) : (
            <Link href="/curso-pensamiento-cientifico" className={styles.navButton}>
              ← Índice
            </Link>
          )}
          ...
          {nextChapter ? (
            <Link
              href={`/curso-pensamiento-cientifico/${nextChapter.module.id}/${nextChapter.chapter.id}`}
              className={styles.navButton}
            >
              Siguiente →
            </Link>
