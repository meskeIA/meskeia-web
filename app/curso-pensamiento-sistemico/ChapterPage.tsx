    ...
    <div className={styles.container}>
      ...
      <div className={styles.chapterContainer}>
        ...
        <nav className={styles.navigation}>
          {prevChapter ? (
            <Link
              href={`/curso-pensamiento-sistemico/${prevChapter.module.id}/${prevChapter.chapter.id}`}
              className={styles.navButton}
            >
              ← Anterior
            </Link>
          ) : (
            <Link href="/curso-pensamiento-sistemico" className={styles.navButton}>
              ← Índice
            </Link>
          )}
          ...
          {nextChapter ? (
            <Link
              href={`/curso-pensamiento-sistemico/${nextChapter.module.id}/${nextChapter.chapter.id}`}
              className={styles.navButton}
            >
              Siguiente →
            </Link>
        ...
        <nav className={styles.bottomNavigation}>
          {prevChapter ? (
            ...
            <Link href="/curso-pensamiento-sistemico" className={styles.bottomNavLink}>
          ...
          {nextChapter ? (
            ...
            <Link href="/curso-pensamiento-sistemico" className={`${styles.bottomNavLink} ${styles.next}`}>
