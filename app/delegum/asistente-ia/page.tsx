...
export default function AsistenteIaPage() {
  return (
    <>
      <AnalyticsTracker appName="delegum-asistente-ia" />
        ...
        <article className={styles.document}>
          ...
          <div className={styles.hero}>
            <div className={styles.heroLockup}>
              <Image
                ...
                priority
              />
              <h1 className={styles.heroWordmark}>Asistente IA</h1>
            </div>
          ...
          <section className={styles.section}>
            <div className={styles.disclaimer}>
              ...
              Consulta el <a href="/delegum/aviso-legal" className={styles.link}>Aviso Legal y Términos de Uso</a> completo.
            </div>
          </section>
