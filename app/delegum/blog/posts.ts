...
export const POSTS: Post[] = [
  {
    slug: 'informacion-contrato-trabajo-real-decreto-723-2026',
    titulo:
      'Desde el 5 de octubre, la empresa debe informar por escrito de los algoritmos que deciden sobre el trabajo',
    fecha: '2026-10-01',
    resumen:
      'El Real Decreto 723/2026 sustituye la norma de 1998 sobre la información que cada persona trabajadora debe recibir al firmar su contrato: la lista pasa a diecisiete elementos, entre ellos el salario desglosado por complementos, el convenio con su código de identificación y los sistemas algorítmicos que decidan sobre la jornada o el salario. Quien ya tenga contrato no la recibe de oficio: tiene que pedirla.',
    cuerpo: [
      'El BOE del 15 de septiembre publicó el Real Decreto 723/2026, de 9 de septiembre (BOE núm. 228), que entra en vigor a los veinte días de su publicación: el 5 de octubre de 2026. Desarrolla el artículo 8.5 del Estatuto de los Trabajadores, transpone parcialmente la Directiva (UE) 2019/1152 sobre condiciones laborales transparentes y previsibles, y deroga el Real Decreto 1659/1998, que era el que regulaba hasta ahora qué información debe recibir por escrito cada persona trabajadora sobre su contrato. Se aplica a todas las empresas y personas trabajadoras incluidas en el Estatuto, aunque el bloque de información solo alcanza a las relaciones laborales «cuya duración sea superior a cuatro semanas» (artículo 2.2); al personal empleado público, con las peculiaridades de su legislación específica.',
      'El artículo 3.2 enumera diecisiete elementos como mínimo. Algunos ya eran habituales, como la identidad de las partes o la fecha de inicio, pero otros piden un grado de detalle nuevo: «la cuantía del salario base y de cada uno de los complementos salariales, indicados de forma separada, así como su periodicidad y método de pago», y el modo de cálculo de los conceptos variables; en los contratos temporales, «la identificación precisa de la causa habilitante»; en las jornadas irregulares, las horas y días de referencia en que la empresa puede exigir el trabajo y los preavisos mínimos antes de cada tarea y de su cancelación; el convenio aplicable con su código, su fecha de publicación y, en su caso, su situación de ultraactividad; el plan de igualdad y el protocolo de acoso; la entidad gestora o colaboradora de la Seguridad Social con la que la empresa cubre cada contingencia, y los planes de pensiones promovidos y las aportaciones realizadas. La letra k) es la de mayor novedad: la empresa debe informar de «la existencia de sistemas algorítmicos o automatizados de toma de decisiones», incluidas sus pautas, criterios y reglas cuando se usen para decidir sobre la jornada, la asignación de tareas, el salario, la progresión profesional, el lugar de trabajo o la extinción del contrato.',
      'Los plazos están en el artículo 7. La información general se entrega «con carácter previo al inicio de la relación laboral», y cualquier cambio posterior «lo antes posible y, a más tardar, el día en que el cambio surta efecto». La obligación se da por cumplida si todo ya figura en el contrato escrito que tiene la persona trabajadora; si solo figura en parte, la empresa debe completar el resto. Puede entregarse en papel o en formato electrónico, siempre que se pueda almacenar e imprimir y que la empresa conserve la prueba de la entrega (artículo 6), y parte de los elementos, como la duración de las vacaciones o los preavisos de extinción, pueden cumplirse con una referencia precisa al convenio o a la norma que los regula (artículo 3.3).',
      'El detalle práctico para quien ya trabaja está en la disposición transitoria única: a los contratos vigentes el 5 de octubre la información no llega de oficio. La empresa debe facilitarla «a la persona trabajadora que lo solicite, en el plazo de treinta días hábiles a partir de la recepción de la solicitud y siempre que no obrara ya en su poder». Las modificaciones que se produzcan después de esa fecha sí deben comunicarse sin que nadie las pida, en el plazo del artículo 7.3. Para facilitar el cumplimiento, la disposición adicional primera encarga al Servicio Público de Empleo Estatal publicar un modelo de documento informativo en un plazo máximo de veinte días desde la publicación del real decreto, pero aclara que ese modelo no condiciona la exigibilidad: mientras no exista, la empresa informa por cualquier medio que garantice constancia y accesibilidad.',
      'Conviene saber también lo que la norma deja fuera. La transposición es parcial porque, según el preámbulo, gran parte de la directiva ya estaba recogida en el ordenamiento español, y hay una omisión expresa: el artículo 10.3 de la directiva, que prevé una indemnización cuando la empresa cancela sin preaviso razonable una tarea ya acordada, no recibe desarrollo reglamentario, siguiendo el criterio del Consejo de Estado de que el problema ya se resuelve combinando los artículos 12.5.d) y 30 del Estatuto. Para cotejar el desglose del salario que exige la letra f) con los conceptos que aparecen cada mes en la nómina, el explicador enlazado abajo recorre uno por uno los devengos, las deducciones y las bases de cotización.',
    ],
    fuente:
      'BOE — Real Decreto 723/2026, de 9 de septiembre (BOE núm. 228, de 15 de septiembre de 2026)',
    fuenteUrl: 'https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-19200',
    visualizadorUrl: 'https://meskeia.com/visualizador-anatomia-nomina/',
    visualizadorTitulo: 'Anatomía de una Nómina',
  },
  {
