 ...
 * (modelo «gestoría»): 49 herramientas, 7 de ellas de escenario.
 *
...
const SERVER_CARD = {
  ...
  serverInfo: {
    ...
    version: '1.0.0',
    description:
      '49 herramientas de fiscalidad, derecho laboral y finanzas en España. IRPF, ' +
  ...
  description:
    ...
    'finanzas en España. 49 herramientas especializadas, incluidas 7 consultas de escenario tipo ' +
