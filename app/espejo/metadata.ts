...
export const faqJsonLd = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: '¿Cómo usar la cámara frontal como espejo en el ordenador?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: '¿Funciona en móvil y en tableta?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Sí. La herramienta es compatible con navegadores modernos en Android e iOS (Chrome, Safari, Firefox). En móvil activa automáticamente la cámara frontal, aunque en algunos dispositivos puede ser necesario seleccionarla manualmente si el navegador abre la trasera por defecto.',
      },
    },
    {
      '@type': 'Question',
