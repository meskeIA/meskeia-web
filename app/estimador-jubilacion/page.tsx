...
import styles from './EstimadorJubilacion.module.css';
  ...
  return (
    <div className={styles.container}>
      ...
      <header className={styles.hero}>
        <h1 className={styles.title}>🎯 Estimador de Jubilación</h1>
      ...
      <RelatedApps apps={getRelatedApps('estimador-jubilacion')} />

      <ShareCard appName="estimador-jubilacion" />
      <Footer appName="estimador-jubilacion" />
    </div>
  );
}
