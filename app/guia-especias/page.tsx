...
const ESPECIAS: Especia[] = [
  // ── PICANTE ──────────────────────────────────────────────
  {
    ...
    familia: 'Picante',
    intensidad: 'Intensa',
    descripcion: 'La especia más usada del mundo. Picor limpio y penetrante gracias a la piperina. Entera conserva mejor el aroma que molida. La búsqueda de la pimienta motivó las expediciones portuguesas a India a partir del siglo XV; durante siglos fue moneda de cambio en Europa.',
  ...
  },
  {
    ...
    familia: 'Dulce / Cálido',
    intensidad: 'Muy intensa',
    descripcion: 'Sabor extremadamente potente y eugenol dominante. Un solo clavo puede perfumar todo un guiso. Usar con mucha moderación. Anestésico natural (eugenol). Los portugueses, holandeses e ingleses se disputaron el monopolio del clavo en las Molucas durante tres siglos; los pueblos locales fueron diezmados en el proceso.',
  ...
  },
  {
    ...
    familia: 'Dulce / Cálido',
    intensidad: 'Media',
    descripcion: 'Cálida y ligeramente dulce con notas leñosas. Usar siempre recién rallada: pierde rápidamente su aroma. En grandes cantidades puede ser tóxica. El monopolio de la nuez moscada fue motivo en 1621 de la masacre de los habitantes de las islas Banda por la VOC holandesa — una de las páginas más sombrías de la historia colonial del Sudeste Asiático.',
  ...
  },
  {
    ...
    familia: 'Herbal',
    intensidad: 'Media',
    descripcion: 'Intensamente cítrica y aromática, diferente a cualquier otro cítrico. Se usan enteras (retirar nervio central) o en juliana muy fina. No sustituibles. El término "kaffir" es un insulto racial en Sudáfrica (prohibido por ley); muchas asociaciones culinarias internacionales recomiendan llamar a esta hoja por su nombre tailandés "makrut".',
