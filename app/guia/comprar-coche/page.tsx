...
const caseStudy = {
  ...
  steps: [
    ...
    { tool: 'Simulador de Préstamos', result: 'Con 8.000€ de entrada y 14.000€ financiados al 5,9% a 4 años: cuota de 328€/mes. Coste total real: 23.750€. Viable sin que ahogue la economía mensual.' },
