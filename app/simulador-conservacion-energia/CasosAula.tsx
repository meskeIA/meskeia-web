 ...
 *
 * Toda la física vive en `./casos.ts`, que a su vez importa las tres fórmulas de la energía
 * de `./motor.ts`, el mismo módulo con el que simula la pista: aquí no se calcula NADA, solo
 * se pinta y se corrige llamando a `comprobarRespuesta`.
 */
...
export default function CasosAula() {
  ...
  function comprobar() {
    // parseSpanishNumber admite «97,6» y «97.6»; devuelve NaN con cualquier otra cosa, y de
    ...
    <div className={styles.casosSection}>
      <div className={styles.casosHeader}>
        ...
        <p className={styles.casosIntro}>
          ...
          profesor puede decir «resuelve los casos 3, 7 y 11» y corregir sin ambigüedad. Todos
          usan g = 9,8 m/s², el mismo valor que trae el simulador de arriba.
        </p>
      </div>
