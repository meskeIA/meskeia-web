 ...
 *
 * Seguían escritas DOS veces a mano —en el JSX de `page.tsx` y aquí abajo— y dos ya habían
 * divergido: «como anejo de la vivienda» frente a «como anejo», y «algunas CCAA» frente a
 * «algunas comunidades autónomas». Las diferencias eran de redacción y no de fondo, así que
 * no engañaban a nadie; lo que demostraban es que el mecanismo seguía abierto, y este es el
 * canal que citan los asistentes de IA sin el disclaimer al lado. Se conserva la redacción
 * del FAQPage —la que dice «comunidades autónomas» y no «CCAA», que es de las abreviaturas
...
export const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: RESPUESTA_VINCULADO_VS_INDEPENDIENTE,
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: RESPUESTA_COMPRAR_SIN_VIVIENDA,
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: RESPUESTA_TIPOS_REDUCIDOS_TRASTERO,
      },
    },
  ],
};
