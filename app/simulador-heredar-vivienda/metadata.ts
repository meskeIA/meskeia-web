...
export const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: `La ganancia patrimonial NO es la simple diferencia entre el precio de venta y el valor declarado en la herencia: al valor de adquisición se le suman los tributos inherentes a la adquisición que pagó el heredero —el ISD y la plusvalía municipal liquidados al heredar (art. 36 LIRPF, que remite al 35.1.b)— y del precio de venta se descuentan los gastos y tributos de la transmisión, incluida la plusvalía municipal de la venta (art. 35.2 LIRPF). Olvidar esos impuestos es el error que hace pagar IRPF de más. Ese beneficio tributa en la base del ahorro del IRPF: ${ESCALA_AHORRO}. Las exenciones del IRPF miran la vivienda habitual DEL QUE VENDE, no la del fallecido: el mayor de 65 años que transmite SU vivienda habitual (art. 33.4.b LIRPF) y la reinversión en la propia vivienda habitual (art. 38 LIRPF). Que la casa fuera la habitual del fallecido es el requisito de la reducción del Impuesto de Sucesiones (art. 20.2.c LISD), que es otro impuesto: para el heredero que vende una casa que no habita, la ganancia tributa entera.`,
      },
    },
    {
      '@type': 'Question',
