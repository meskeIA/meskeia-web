...
export const metadata: Metadata = {
  title: 'Anatomía de un Smartphone (Móvil o Celular) - Componentes, Minerales, Coste Real | meskeIA',
  description: 'Descubre qué hay dentro de un smartphone (móvil o celular): procesador, batería, cámaras, los 30+ minerales de 15 países, el desglose real de costes y la obsolescencia. Explicador visual interactivo.',
  keywords: 'smartphone componentes, minerales smartphone, qué hay dentro de un celular, componentes del celular, cobalto congo, litio chile, coste fabricación móvil, coste fabricación celular, obsolescencia programada, basura electrónica, derecho a reparar, explicador visual',
  ...
  openGraph: {
    type: 'website',
    title: 'Anatomía de un Smartphone (Móvil o Celular) - Componentes, Minerales y Coste Real',
    description: 'Qué hay dentro de tu móvil o celular, de dónde vienen sus materiales, cuánto cuesta realmente fabricarlo y qué pasa cuando lo tiras.',
  ...
  twitter: {
    ...
    description: 'Procesador, batería, 30+ minerales de 15 países, márgenes de beneficio y obsolescencia: todo lo que esconde tu móvil o celular.',
...
export const jsonLd = generateWebAppSchema({
  ...
  description: 'Explicador visual interactivo sobre la anatomía de un smartphone (móvil o celular): componentes internos (pantalla, procesador, batería, cámaras, antenas), minerales y países de origen (litio, cobalto, tierras raras), desglose real de costes de fabricación y el problema de la obsolescencia y los residuos electrónicos.',
  url: 'https://meskeia.com/visualizador-anatomia-smartphone/',
...
export const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Sí: son nombres distintos para el mismo dispositivo. "Móvil" se usa en España, "celular" en Hispanoamérica y "smartphone" es el anglicismo común en ambas regiones. Los componentes, minerales y el desglose de costes que muestra este explicador son idénticos sea cual sea el nombre que le des al aparato.',
      },
    },
  ],
};
