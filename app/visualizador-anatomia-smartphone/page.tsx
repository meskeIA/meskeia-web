...
const COMPONENTES: Componente[] = [
  ...
  { id: 'ram', nombre: 'RAM (8 GB)', icono: '⚡', tipo: 'Memoria rápida', funcion: 'Almacena datos temporales de las apps abiertas para acceso instantáneo.', materiales: 'Silicio, tántalo, oro (contactos)', dato: 'Lee/escribe a ~50 GB/s — 500× más rápido que el SSD', color: '#F59E0B' },
...
const MINERALES: Mineral[] = [
  ...
  { nombre: 'Tántalo', icono: '💾', uso: 'Condensadores (miniaturización)', paisPrincipal: 'Congo / Ruanda', bandera: '🇨🇩🇷🇼', cuotaMundial: 'África Central ~60%', problema: 'Mineral de conflicto — financia guerras civiles', color: '#6B7280' },
