...
const GASTOS: CategoriaGasto[] = [
  ...
  { id: 'ahorro', nombre: 'Ahorro / resto', icono: '🐷', pct: 7, color: '#48A9A6', explicacion: 'Lo que sobra después de todos los gastos. La tasa de ahorro media en España ronda el 7%, frente al ~13% de la media europea. La diferencia responde en parte a salarios más ajustados y a un peso mayor de la vivienda en el presupuesto, no necesariamente a hábitos.', consejo: 'Págate primero: aparta el ahorro al principio del mes, no al final. Automatizar una transferencia el día 1 es la técnica más efectiva.' },
];
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <p>
            ...
            Si los gastos suben al ritmo de los ingresos, el porcentaje de ahorro no mejora.
            Es legítimo subir el nivel de vida cuando sube el sueldo; lo útil es decidirlo
