...
const ELEMENTOS_SMARTPHONE: ElementoSmartphone[] = [
  ...
  { simbolo: 'Ta', nombre: 'Tantalio', numAtomico: 73, componente: 'Condensadores', uso: 'Almacena carga eléctrica', detalle: 'Condensadores diminutos que regulan el voltaje. La mayor parte del tantalio mundial viene del Congo.', categoria: 'transicion' },
