...
const CLASES_ACTIVOS: ClaseActivo[] = [
  {
    ...
    rentabilidadNominal: '~9-10% anual (1972-2024, MSCI World en USD)',
    rentabilidadReal: '~6-7% anual descontada inflación',
  ...
  },
  {
    ...
    rentabilidadNominal: '~4-5% anual histórico · 3-4% actual (2024)',
    rentabilidadReal: '~1-2% anual descontada inflación',
  ...
  },
  {
    ...
    rentabilidadNominal: '~7-9% anual (REITs globales, 1990-2024)',
    rentabilidadReal: '~4-5% anual descontada inflación',
  ...
  },
  {
    ...
    rentabilidadNominal: '~7-8% anual (oro, 1971-2024) · muy variable en otras',
    rentabilidadReal: '~3-4% anual (oro)',
  ...
  },
  {
    ...
    rentabilidadNominal: '~3-4% actual (2024, zona euro) · históricamente muy variable',
...
const CARTERAS: CarteraTipo[] = [
  ...
  },
  {
    ...
    rentabilidadEsperada: '~5-7% anual',
    volatilidad: '~9-11%',
  },
  {
    nombre: 'Crecimiento',
    ...
    rentabilidadEsperada: '~7-9% anual',
    volatilidad: '~12-14%',
  },
  {
    nombre: 'Especulativa',
                  ...
                  {[
                    {
                      ...
                      detalle:
                        '~9-10% nominal anual en bolsa global (1972-2024). El tiempo en el mercado supera al timing del mercado.',
                    },
                    {
