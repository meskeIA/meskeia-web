...
export const appRelationsMap: Record<string, RelatedApp[]> = {
  ...
  'simulador-gastos-compraventa-local-comercial': [
    { url: '/simulador-gastos-compraventa-nave-industrial/', icon: '🏭', name: 'Gastos Nave Industrial', description: 'IVA, ITP y AJD de una nave' },
    { url: '/simulador-gastos-compraventa-solar/', icon: '🏗️', name: 'Gastos Solar', description: 'Terreno edificable: IVA o ITP' },
    { url: '/simulador-gastos-compraventa-terreno-rustico/', icon: '🌾', name: 'Gastos Finca Rústica', description: 'Terreno rústico: solo ITP' },
    { url: '/estimador-compraventa-inmueble/', icon: '🏠', name: 'Gastos Compraventa Vivienda', description: 'ITP/IVA, notaría, plusvalía e IRPF del vendedor' },
    { url: '/simulador-gastos-compraventa-garaje/', icon: '🚗', name: 'Gastos Garaje', description: 'Calcula los gastos de tu garaje' },
    { url: '/estimador-plusvalia-municipal/', icon: '🏛️', name: 'Plusvalía Municipal', description: 'Calcula el impuesto del vendedor' },
  ],
  ...
  'simulador-gastos-compraventa-solar': [
    ...
    { url: '/simulador-gastos-compraventa-local-comercial/', icon: '🏪', name: 'Gastos Local Comercial', description: 'IVA, ITP y renuncia a la exención' },
    { url: '/estimador-compraventa-inmueble/', icon: '🏠', name: 'Gastos Compraventa Vivienda', description: 'ITP/IVA, notaría, plusvalía e IRPF del vendedor' },
    { url: '/estimador-plusvalia-municipal/', icon: '🏛️', name: 'Plusvalía Municipal', description: 'Impuesto del vendedor (suelo urbano)' },
    { url: '/estimador-hipoteca/', icon: '🏦', name: 'Simulador Hipoteca', description: 'Calcula tu cuota mensual' },
  ],
  ...
  'diccionario-rimas': [
    { url: '/contador-silabas/', icon: '📐', name: 'Contador Sílabas', description: 'Mide el verso con sinalefas y detecta la estrofa' },
  ...
  'prueba-microfono': [{ url: '/sonometro/', icon: '🔊', name: 'Sonómetro', description: 'El micro ya funciona: mide el ruido de la sala' }, { url: '/prueba-camara/', icon: '📷', name: 'Prueba Cámara', description: 'Test de webcam' }, { url: '/luxometro/', icon: '💡', name: 'Luxómetro', description: 'Medir luz ambiente' }, { url: '/amplificador-sonido/', icon: '🦻', name: 'Amplificador de Sonido', description: 'Escucha amplificada en vivo' }],
  'sonometro': [{ url: '/analizador-espectro/', icon: '📊', name: 'Analizador Espectro', description: 'Qué frecuencias componen ese ruido' }, { url: '/generador-ruido-blanco/', icon: '🌫️', name: 'Ruido Blanco, Rosa y Marrón', description: 'Enmascara el ruido que acabas de medir' }, { url: '/generador-tonos/', icon: '🔊', name: 'Generador Tonos', description: 'Tono de referencia para calibrar la medición' }, { url: '/amplificador-sonido/', icon: '🦻', name: 'Amplificador de Sonido', description: 'Oír mejor lo que apenas se distingue' }, { url: '/comprobador-altavoces/', icon: '🔊', name: 'Comprobador de Altavoces', description: 'Canal L/R, fase y barrido de frecuencia' }],
  ...
  'diapason': [
    ...
    { url: '/sonometro/', icon: '🔊', name: 'Sonómetro', description: 'A cuántos decibelios ensayas' },
    { url: '/metronomo/', icon: '🎵', name: 'Metrónomo', description: 'Tempo musical' },
    { url: '/transpositor-acordes/', icon: '🎵', name: 'Transpositor de Acordes', description: 'Cambia la tonalidad de tu canción' },
  ],
  'generador-tonos': [{ url: '/analizador-espectro/', icon: '📊', name: 'Analizador Espectro', description: 'Visualiza frecuencias' }, { url: '/sonometro/', icon: '🔊', name: 'Sonómetro', description: 'Cuántos dB entrega tu equipo de verdad' }, { url: '/comprobador-altavoces/', icon: '🔊', name: 'Comprobador de Altavoces', description: 'Canales, fase y graves: diagnostica el equipo' }, { url: '/afinador-instrumentos/', icon: '🎸', name: 'Afinador', description: 'Afina tu instrumento' }, { url: '/generador-ruido-blanco/', icon: '🌫️', name: 'Ruido Blanco, Rosa y Marrón', description: 'Sonido de fondo con temporizador' }],
  ...
  'amplificador-sonido': [
    { url: '/sonometro/', icon: '🔊', name: 'Sonómetro', description: 'Cuánto ruido hay antes de amplificar' },
