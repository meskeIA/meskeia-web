...
export const appRelationsMap: Record<string, RelatedApp[]> = {
  ...
  'prueba-microfono': [{ url: '/prueba-camara/', icon: '📷', name: 'Prueba Cámara', description: 'Test de webcam' }, { url: '/luxometro/', icon: '💡', name: 'Luxómetro', description: 'Medir luz ambiente' }, ...audioApps.slice(0, 2)],
