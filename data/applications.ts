...
export const applicationsDatabase: Application[] = [
  ...
  { name: "Planificador Embarazo y Bebé", category: "Salud y Bienestar", contexts: ["casa"], icon: "🤰", description: "Planifica tu embarazo: calculadora FPP, checklist por trimestre, lista de compras del bebé y calendario de vacunación España 2024", url: "/calculadora-fecha-parto/", keywords: ["embarazo", "fecha parto", "fpp", "semanas gestacion", "trimestre", "fur", "regla naegele", "checklist embarazo", "lista compras bebe", "vacunas recien nacido", "canastilla"] },
