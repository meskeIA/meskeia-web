...
export const applicationsDatabase: Application[] = [
  ...
  { name: "Calculadora Coste Real a Plazos", suites: ["finanzas"], contexts: ["dinero", "casa"], icon: "💳", description: "Descubre el coste real de financiar productos a plazos. Calcula la TAE, los intereses ocultos y cuánto pagas de más", url: "/calculadora-coste-plazos/", keywords: ["financiacion", "plazos", "TAE", "TIN", "intereses", "cuotas", "credito consumo", "comprar a plazos"] },
  { name: "Calculadora de Deuda", suites: ["finanzas"], contexts: ["dinero"], icon: "🎯", description: "Elimina tus deudas más rápido. Compara el método bola de nieve vs avalancha y descubre cuál te ahorra más", url: "/calculadora-deuda/", keywords: ["deudas", "bola de nieve", "avalancha", "eliminar deudas", "pagar deudas", "tarjetas credito", "prestamos"] },
  ...
  { name: "Calculadora de Colesterol", suites: ["salud"], contexts: ["casa"], icon: "🩺", description: "Analiza tus niveles de colesterol: ratios CT/HDL, LDL/HDL, fórmula de Friedewald y recomendaciones de riesgo cardiovascular", url: "/calculadora-colesterol/", keywords: ["colesterol", "hdl", "ldl", "trigliceridos", "cardiovascular", "friedewald", "ratio colesterol", "colesterol bueno", "colesterol malo"] },
