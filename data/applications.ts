...
export const applicationsDatabase: Application[] = [
  ...
  { name: "Generador de Contraseñas", category: "Productividad", contexts: ["trabajo", "casa"], icon: "⚡", description: "Crea contraseñas seguras y personalizadas con diferentes niveles de complejidad", url: "/generador-contrasenas/", keywords: ["password", "seguridad", "contrasena", "generar", "segura"] },
