...
export const applicationsDatabase: Application[] = [
  ...
  { name: "Curso de Optimización para IAs (GEO/AEO)", category: "Herramientas Académicas", contexts: ["estudio", "trabajo", "creando"], icon: "🤖", description: "Aprende GEO y AEO: optimiza tu contenido para que ChatGPT, Perplexity y Gemini lo citen. LLMs, RAG, E-E-A-T, Schema Markup y estrategias por plataforma. 6 capítulos", url: "/curso-optimizacion-ia/", keywords: ["geo", "aeo", "optimizacion ia", "chatgpt seo", "perplexity", "gemini", "llm", "rag", "eeat", "schema markup", "citaciones ia", "seo 2025"] },
