...
export const applicationsDatabase: Application[] = [
  ...
  { name: "Calculadora Huella de Carbono", category: "Calculadoras Practicas", contexts: ["casa", "curiosidad"], icon: "🌍", description: "Calcula tu huella de carbono personal anual. Analiza transporte, hogar, alimentacion y consumo. Compara con la media espanola y obten consejos para reducirla", url: "/calculadora-huella-carbono/", keywords: ["huella carbono", "CO2", "emisiones", "sostenibilidad", "medio ambiente", "carbono personal", "transporte", "alimentacion", "consumo"] },
  ...
  { name: "Planificador de Mudanzas", category: "Calculadoras Prácticas", contexts: ["casa"], icon: "📦", description: "Organiza tu mudanza con checklist de tareas por fases, inventario de objetos por habitación y control de presupuesto estimado vs real", url: "/planificador-mudanzas/", keywords: ["mudanza", "mudarse", "inventario", "presupuesto mudanza", "checklist mudanza", "tareas mudanza", "organizar mudanza", "traslado"] },
  ...
  { name: "Generador de Avatares", category: "Diseño Web", contexts: ["creando", "trabajo"], icon: "👤", description: "Genera avatares únicos y personalizados a partir de tu nombre o texto. 8 estilos diferentes, descarga PNG, sin subir fotos. 100% privado", url: "/generador-avatares/", keywords: ["avatar", "generador", "perfil", "identicon", "imagen perfil", "foto perfil", "dicebear", "gravatar", "iniciales"] },
  ...
  { name: "Simulador de Cartera de Inversión", category: "Finanzas Personales", contexts: ["dinero"], icon: "📊", description: "Simula la evolución de tu cartera con Monte Carlo. Sharpe, volatilidad, percentiles y probabilidad de alcanzar objetivos", url: "/simulador-cartera-inversion/", keywords: ["cartera", "monte carlo", "simulacion", "sharpe", "volatilidad", "inversion", "renta variable", "renta fija", "backtesting", "percentiles"] },
  ...
  { name: "Simulador de Física", category: "Herramientas Académicas", contexts: ["estudio"], icon: "🔬", description: "Simulador interactivo con animaciones en tiempo real: caída libre, péndulo simple, tiro parabólico, ondas y movimiento armónico simple (MAS)", url: "/simulador-fisica/", keywords: ["fisica", "simulador", "caida libre", "pendulo", "proyectil", "ondas", "resorte", "mas", "animacion", "interactivo"] },
  ...
  { name: "Cara o Cruz", category: "Juegos y Entretenimiento", contexts: ["relax", "curiosidad"], icon: "🪙", description: "Lanza una moneda virtual con animación realista. Incluye historial de lanzamientos, estadísticas de probabilidad y visualización de la ley de grandes números", url: "/cara-o-cruz/", keywords: ["cara", "cruz", "moneda", "coin flip", "aleatorio", "probabilidad", "decision", "lanzar"] },
  ...
  { name: "Conversor de Unidades RF", category: "Productividad", contexts: ["estudio", "trabajo"], icon: "📡", description: "Conversor especializado para radiofrecuencia: dBm↔Watts, dBµV, VSWR↔Return Loss, frecuencia↔longitud de onda. Ideal para ingenieros RF y radioaficionados", url: "/conversor-unidades-rf/", keywords: ["conversor rf", "dbm", "watts", "vswr", "return loss", "dbmv", "dbuv", "radiofrecuencia", "antenas", "longitud onda", "frecuencia", "radioaficionado", "telecomunicaciones"] },
  ...
  { name: "Luxómetro / Fotómetro", category: "Productividad", contexts: ["trabajo", "creando"], icon: "💡", description: "Mide la intensidad de luz en lux con tu dispositivo. Ideal para fotógrafos: incluye recomendaciones de ISO, apertura y velocidad", url: "/luxometro/", keywords: ["luxometro", "fotometro", "luz", "lux", "fotografia", "exposicion", "iso", "apertura", "iluminacion", "medir luz"] },
  { name: "Golden Hour - Hora Dorada", category: "Productividad", contexts: ["creando", "curiosidad"], icon: "🌅", description: "Calcula las horas de luz dorada y azul para fotografía. Amanecer, atardecer y crepúsculos según tu ubicación", url: "/golden-hour/", keywords: ["golden hour", "hora dorada", "hora azul", "blue hour", "amanecer", "atardecer", "fotografia", "crepusculo", "luz natural"] },
  { name: "Sonómetro / Decibelímetro", category: "Productividad", contexts: ["trabajo", "casa"], icon: "🔊", description: "Mide el nivel de ruido en decibelios (dB) con tu micrófono. Ideal para documentar ruido, verificar ambientes de trabajo o medir contaminación acústica", url: "/sonometro/", keywords: ["sonometro", "decibelimetro", "ruido", "decibelios", "db", "medir ruido", "contaminacion acustica", "nivel sonoro", "microfono"] },
  { name: "Metrónomo Online", category: "Productividad", contexts: ["creando", "estudio"], icon: "🎵", description: "Metrónomo online con tempo ajustable (40-220 BPM), tap tempo, múltiples compases y visualización del pulso. Ideal para práctica musical", url: "/metronomo/", keywords: ["metronomo", "tempo", "bpm", "musica", "practica musical", "compas", "tap tempo", "ritmo", "musicos", "beats"] },
  ...
  { name: "Analizador de Espectro", category: "Productividad", contexts: ["creando", "estudio", "curiosidad"], icon: "📊", description: "Visualiza las frecuencias de audio en tiempo real con FFT. Muestra bandas de frecuencia, nota dominante y espectrograma. Ideal para músicos y técnicos de sonido", url: "/analizador-espectro/", keywords: ["analizador espectro", "fft", "frecuencias", "audio", "espectrograma", "visualizador", "musica", "sonido", "hertz", "bandas frecuencia"] },
  { name: "Nivel de Burbuja Digital", category: "Productividad", contexts: ["casa", "trabajo"], icon: "📐", description: "Nivel de burbuja digital con inclinómetro. Mide ángulos y pendientes con los sensores de tu móvil. Ideal para bricolaje, colgar cuadros y medir rampas", url: "/nivel-burbuja/", keywords: ["nivel burbuja", "inclinometro", "nivel digital", "medir angulos", "pendiente", "bricolaje", "colgar cuadros", "clinometro", "spirit level"] },
  ...
  { name: "Conversor de Formatos", category: "Texto y Conversores", contexts: ["trabajo", "creando"], icon: "🔄", description: "Convierte archivos entre JSON, CSV, Excel, XML y YAML. 100% privado, todo se procesa en tu navegador", url: "/conversor-formatos/", keywords: ["json", "csv", "excel", "xml", "yaml", "convertir", "formatos", "datos", "exportar", "importar"] },
  ...
  { name: "Conjugador de Verbos Español", category: "Texto y Conversores", contexts: ["estudio"], icon: "📖", description: "Conjuga cualquier verbo español en todos los tiempos: indicativo, subjuntivo e imperativo. Incluye 60+ verbos irregulares", url: "/conjugador-verbos/", keywords: ["conjugador", "verbos", "español", "conjugacion", "indicativo", "subjuntivo", "imperativo", "irregulares", "gramatica"] },
  { name: "Entrenador Tablas Multiplicar", category: "Herramientas Académicas", contexts: ["estudio"], icon: "✖️", description: "Aprende las tablas de multiplicar jugando. Juego educativo con niveles, puntuación, rachas y medallas para niños de primaria", url: "/tablas-multiplicar/", keywords: ["tablas multiplicar", "matematicas niños", "primaria", "educativo", "juego", "aprender multiplicar", "gamificado"] },
  { name: "Minerales del Mundo", category: "Herramientas Académicas", contexts: ["estudio", "curiosidad"], icon: "💎", description: "Guía de 50 minerales esenciales con composición química, dureza Mohs, sistema cristalino, usos y curiosidades", url: "/minerales-del-mundo/", keywords: ["minerales", "geologia", "mineralogia", "cristales", "mohs", "cuarzo", "diamante", "pirita", "silicatos", "oxidos"] },
  { name: "Huesos del Cuerpo Humano", category: "Herramientas Académicas", contexts: ["estudio"], icon: "🦴", description: "Guía completa de los 206 huesos del esqueleto humano: nombre latino, tipo, región, articulaciones, función y curiosidades", url: "/huesos-cuerpo-humano/", keywords: ["huesos", "esqueleto", "anatomia", "medicina", "craneo", "vertebras", "femur", "humero", "costillas", "articulaciones"] },
