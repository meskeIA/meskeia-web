...
export const COQUINUM_APP_CATEGORIA: Record<string, string> = {
  ...
  'alergenos-alimentarios': 'cocina-recetas',
  'glosario-tecnicas-cocina': 'cocina-recetas',
  'tipos-corte-cocina': 'cocina-recetas',
...
export const COQUINUM_APP_INFO: Record<string, CoquinumAppInfo> = {
  ...
  'alergenos-alimentarios': { nombre: 'Los 14 alérgenos alimentarios', icon: '🥜' },
  'glosario-tecnicas-cocina': { nombre: 'Glosario de técnicas de cocina', icon: '📖' },
  'tipos-corte-cocina': { nombre: 'Tipos de corte en cocina', icon: '🔪' },
  ...
  'puntos-humo-aceites': { nombre: 'Puntos de humo de los aceites', icon: '🔥' },
