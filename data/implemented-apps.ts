...
export const implementedAppsUrls = [
  ...
  "/amplificador-sonido/",         // Amplificador de escucha en vivo (accesibilidad auditiva)
  ...
  "/teclado-barrido-switch/",           // Teclado de barrido fila-columna por switch: práctica de acceso motriz
  ...
  "/guia/primer-empleo/",               // Journey carrera/empleo: competencias, CV, entrevista y primer sueldo — 5 herramientas
  "/guia/seguridad-internet/",          // Journey seguridad digital: contraseñas, 2FA, phishing, privacidad y recuperación — 6 herramientas
  ...
  "/visualizador-historia/maya/", // Civilización Maya -2000→1500, 10 hitos, 6 eras
  "/visualizador-historia/azteca/", // Imperio Azteca 1200→1521, 10 hitos, 6 eras
  "/visualizador-historia/inca/", // Imperio Inca 1200→1572, 10 hitos, 6 eras
  "/visualizador-historia/olmeca/", // Civilización Olmeca -1600→-400, 10 hitos, 6 eras
  "/visualizador-historia/tolteca/", // Imperio Tolteca 700→1200, 10 hitos, 6 eras
  ...
  "/visualizador-historia/reino-kongo/",                   // Reino del Kongo: de Mbanza Kongo a la Angola portuguesa
  "/visualizador-historia/reino-benin/",                   // Reino de Benín (Edo): de los obas a la expedición de 1897
  "/visualizador-historia/imperio-oyo/",                   // Imperio de Oyó y los Estados Yoruba: de Ifé a las guerras del s.XIX
  ...
  "/calculadora-temperatura-masa/",       // DDT: temperatura del agua para alcanzar la temperatura deseada de la masa
  "/calculadora-puntos-azucar/",          // Fases de cocción del azúcar: almíbar → caramelo oscuro por temperatura
  ...
  // Química de orbitales (2026-08)
  "/calculadora-configuracion-electronica/",  // Configuración electrónica de elementos e iones: Möller, Hund, cajas, números cuánticos y las 20 excepciones
