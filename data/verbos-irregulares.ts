...
export const verbosIrregulares: VerboIrregular[] = [
  ...
  { infinitive: 'take',  pastSimple: 'took',       pastParticiple: 'taken',   spanish: 'tomar / llevar',      level: 'A1' },
  ...
  { infinitive: 'meet',  pastSimple: 'met',     pastParticiple: 'met',     spanish: 'conocer / encontrarse con', level: 'A2' },
  ...
  { infinitive: 'drive', pastSimple: 'drove',   pastParticiple: 'driven',  spanish: 'conducir / manejar', level: 'A2' },
  ...
  { infinitive: 'forget', pastSimple: 'forgot',  pastParticiple: 'forgotten', spanish: 'olvidar',             level: 'B1', varianteParticipio: { forma: 'forgot', variedad: 'AmE' } },
