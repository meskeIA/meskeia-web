...
// ─────────────────────────────────────────────────────────────────────────────
test('CASO 0 · DA 61.ª de 2026: con 19.000 € el IRPF es 1.354,50 € y el neto 16.410,50 €', async ({ page }) => {
  ...
  // Neto = 19.000 − 1.235 − 1.354,50 = 16.410,50 €
  ...
  expect(await pasoCascada(page, '= Salario NETO Anual')).toBe('16.410,50 €');
});
